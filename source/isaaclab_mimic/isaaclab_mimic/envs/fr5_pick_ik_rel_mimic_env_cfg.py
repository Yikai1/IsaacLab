...
from isaaclab_tasks.manager_based.manipulation.pick.config.fr.pick_ik_rel_env_cfg import FR5CubePickEnvCfg


@configclass
class FR5CubePickIKRelMimicEnvCfg(FR5CubePickEnvCfg, MimicEnvCfg):
    """
