...
class FR5TVControlPickIKRelMimicEnv(ManagerBasedRLMimicEnv):
    """
    Isaac Lab Mimic environment wrapper class for FR5 Cube Stack IK Rel env.
    """
    ...
    def target_eef_pose_to_action(
        ...
        if action_noise_dict is not None:
            noise = action_noise_dict["fr5"] * torch.randn_like(pose_action)
            pose_action += noise
