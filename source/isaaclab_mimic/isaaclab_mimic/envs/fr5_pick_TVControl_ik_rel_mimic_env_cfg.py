...
from isaaclab_tasks.manager_based.manipulation.cluttered_pick.config.fr.pick_joint_pos_env_cfg import FR5TVControlPickEnvCfg


@configclass
class FR5CubePickIKRelMimicEnvCfg(FR5TVControlPickEnvCfg, MimicEnvCfg):
    """
    ...
    def __post_init__(self):
        ...
        subtask_configs.append(
            SubTaskConfig(
                ...
                description="Grasp TVcontrol",
                next_subtask_description="Put TVcontrol into the purple box",
            )
        )
